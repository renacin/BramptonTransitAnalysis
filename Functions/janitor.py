...
class Janitor():
    ...
    def __db_check(self):
        ...
        # Create Table That Will Store All Bus Locations
        try:
        ...
        # Create UID Table That Will Help Identify Records Already Stored
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create Error Table That Will Store All Errors Generated By This Project
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create A Table That Will Store The Date Range For GTFS Data Stored
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create A Table That Will Store The Route Information From The GTFS Data
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create A Table That Will Store The Trip Information From The GTFS Data
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create A Table That Will Store The Stops Information From The GTFS Data
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''
        ...
        # Create A Table That Will Store The Stop Times Information From The GTFS Data
        try:
            conn = sqlite3.connect(self.db_path)
            conn.execute(
            '''

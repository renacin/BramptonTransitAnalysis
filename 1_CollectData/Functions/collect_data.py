...
class DataCollector:
    ...
    def __frmt_data_s3(self, data_f):
        ...
        # FOR TESTING ONLY!!!
        err_ids = ["23924135-240429-MULTI-Weekday-01", "23925071-240429-MULTI-Weekday-01", "23925135-240429-MULTI-Weekday-01", "23925141-240429-MULTI-Weekday-01"]
        transit_df = transit_df[transit_df["TRIP_ID"].isin(err_ids)]
        transit_df.to_csv("Test.csv")
    ...
    def frmt_rwbslc_data(self, td_dt_mx):
        ...
        # Please Delete
        td_dt_mx = datetime.strptime("2024-05-11", '%Y-%m-%d')
